...
export declare const VibeOptionSchema: z.ZodEnum<["CHILL", "ROMANTIC", "CREATIVE", "PLAYFUL", "ACTIVE", "LUXE"]>;
...
export declare const BookingLikelihoodSchema: z.ZodEnum<["BOOK_AHEAD", "CHECK_AVAILABILITY", "WALK_IN_LIKELY"]>;
export declare const BookingSignalSchema: z.ZodObject<{
    score: z.ZodNumber;
    label: z.ZodEnum<["BOOK_AHEAD", "CHECK_AVAILABILITY", "WALK_IN_LIKELY"]>;
}, "strip", z.ZodTypeAny, {
    score?: number;
    label?: "BOOK_AHEAD" | "CHECK_AVAILABILITY" | "WALK_IN_LIKELY";
}, {
    score?: number;
    label?: "BOOK_AHEAD" | "CHECK_AVAILABILITY" | "WALK_IN_LIKELY";
}>;
export declare const CandidateSchema: z.ZodObject<{
    ...
    reviewCount?: number;
    priceLevel?: number;
    tags?: ("ROMANTIC" | "CROWDED" | "LOUD" | "ARTSY" | "BUDGET_FRIENDLY" | "COZY" | "DATE_NIGHT" | "ICONIC" | "NATURE" | "PREMIUM")[];
    booking?: {
        score?: number;
        label?: "BOOK_AHEAD" | "CHECK_AVAILABILITY" | "WALK_IN_LIKELY";
    };
...
export declare const GenerateItineraryRequestSchema: z.ZodObject<{
    ...
    budget: z.ZodEnum<["$", "$$", "$$$"]>;
    vibe: z.ZodEnum<["CHILL", "ROMANTIC", "CREATIVE", "PLAYFUL", "ACTIVE", "LUXE"]>;
...
export declare const GenerateItineraryResponseSchema: z.ZodObject<{
    ...
    meta: z.ZodObject<{
        ...
        textSearchOptions: z.ZodOptional<z.ZodArray<z.ZodString, "many">>;
    }, "strip", z.ZodTypeAny, {
        usedCache?: boolean;
        warnings?: string[];
...
export declare const ReplaceStopWithTextSearchRequestSchema: z.ZodObject<{
    originPlaceId: z.ZodString;
    stopIndex: z.ZodNumber;
    query: z.ZodString;
    itinerary: z.ZodObject<{
        itineraryId: z.ZodString;
        stops: z.ZodArray<z.ZodObject<{
            kind: z.ZodEnum<["PLACE", "EVENT"]>;
            name: z.ZodString;
